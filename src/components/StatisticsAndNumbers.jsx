...
const statsGroups = [
  [
    ...
    { value: "35", label1: "الكليات" },
  ],
  [
    { value: "141", label1: "برامج البكالوريوس" },
    { value: "17", label1: "برامج التعليم عن بعد" },
    { value: "15", label1: "البرامج البحثية" },
    { value: "39", label1: "الأندية الطلابية" },
  ],
  [
    { value: "1", label1: "محليًا في", label2: "الاستدامة" },
    { value: "5", label1: "عربيًا" },
    { value: "143", label1: "عالميًا" },
    { value: "267", label1: "الطلبة الحاصلين على", label2: "جوائز محلية ودولية" },
  ],
];
